...
//USUARIOS
const actors = require("./routes/actors") // Importa el enrutador de usuarios
app.use("/actors", actors); // Utiliza el enrutador de usuarios para manejar las solicitudes dirigidas a /users
